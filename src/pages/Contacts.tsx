...
import { 
  Mail, Phone, MapPin, Clock, Send, Camera, Navigation, ChevronDown 
} from 'lucide-react';
...
export default function Contacts() {
  ...
  return (
    <Layout>
      <SEO title={t.contacts.title} description={t.contacts.subtitle} path="/contacts" />
  ...
  />
              ...
              <div className="p-6 md:p-8 flex flex-col justify-center">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold">{t.contacts.visitOffice}</h3>
                </div>

                <div className="space-y-5 text-muted-foreground">
                  <div>
                    <p className="text-lg font-medium text-foreground">{t.contacts.addressValue}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li><span className="font-medium text-foreground">Mon–Fri:</span> 9:00 AM – 6:00 PM</li>
                      <li><span className="font-medium text-foreground">Saturday:</span> 10:00 AM – 4:00 PM</li>
                      <li><span className="font-medium text-foreground">Sunday:</span> {t.contacts.closed}</li>
                    </ul>
                  </div>

                  <Button asChild className="w-full md:w-auto">
                    <a href="https://maps.google.com?q=123+Business+Avenue" target="_blank" rel="noopener noreferrer">
  ...
  {/* EMAIL */}
          ...
          <div className="max-w-5xl mx-auto">
            <h2 className="text-2xl font-bold text-center mb-8">{t.contacts.faqTitle}</h2>
            <Accordion type="single" collapsible className="bg-card rounded-xl shadow-sm border">
              {faqs.map((faq, i) => (
