      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">{t.catalog.title}</h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">{t.catalog.subtitle}</p>
          </div>
          ...
          {/* нижний внутренний отступ секции */}
